...
namespace Idionline
{
    public class DataAccess
    {
        ...
        //    };
        //    Definition def = new Definition { Text = "hahaha", Addition = "666", IsMarked = false, Links = dic };
        //    Definition def2 = new Definition { Text = "haa", Addition = "345sgsdgsdgc6", IsMarked = true, Links = dic };
        //    List<Definition> defs = new List<Definition>
        //    {
        //        def,
        //        def2
        //    };
        //    _idioms.InsertOne(new Idiom { Name = "TEST", Definitions = defs, Source = "233333", LastEditor = "fssssss", UpdateTimeUT = 666666, Index = 'C' });
        //    return "Done!";
        //}
        ...
        {
            Dictionary<string, string> dic = new Dictionary<string, string>();
            List<Idiom> items = _idioms.Find(x => x.Index == index).ToList();
            foreach (var item in items)
            {
                dic.Add(item.Id.ToString(), item.Name);
            }
